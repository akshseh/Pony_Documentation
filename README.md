...
## Your first program
Let's learn to write a program to print "Hello, world!". First, create a directory called `helloworld`:
```
$ mkdir helloworld
$ cd helloworld
```
The name of the directory matters. It's the name of your program! When your program is compiled, the resulting executable binary will have the same name as the directory your program lives in.
Then, create a file in that directory called `main.pony`.

The name of the file does not matter to the compiler. Pony doesn't care about filenames other than that they end in .pony.
